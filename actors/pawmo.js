// Import animasi karakter Pawmo
import { animatePawmo } from '../animations/pawmo.js';

// Import geometri dari geometri kedua
import { group } from "../geometry2/group.js";
import { pawmoTorso } from "../geometry2/pawmo-torso.js";
...
import { paraboloid } from "../geometry2/paraboloid.js";

// Fungsi patchRenderPrototype untuk gambar geometri)
...
export function createPawmo(animationLoop) {
    ...
    // pawmoFoot tidak di-patch karena render sudah di override manual
    ...
    const Torso = new pawmoTorso(GL, SHADER_PROGRAM, _pos, _col, _Mmatrix, _normal, {
        color: PAWMO_ORANGE
    });
    const Left_Hand = new pawmoHand(GL, SHADER_PROGRAM, _pos, _col, _Mmatrix, _normal, {
        orange: PAWMO_ORANGE, white: PAWMO_WHITE
    });
    const Right_Hand = new pawmoHand(GL, SHADER_PROGRAM, _pos, _col, _Mmatrix, _normal, {
        orange: PAWMO_ORANGE, white: PAWMO_WHITE
    });
    const Left_Foot = new pawmoFoot(GL, SHADER_PROGRAM, _pos, _col, _Mmatrix, _normal, _NMatrixLoc, {
        color: PAWMO_ORANGE
    });
    const Right_Foot = new pawmoFoot(GL, SHADER_PROGRAM, _pos, _col, _Mmatrix, _normal, _NMatrixLoc, {
        color: PAWMO_ORANGE
    });
    ...
    LIBS.set_I4(Head.POSITION_MATRIX); LIBS.translateY(Head.POSITION_MATRIX, 2.0);
    ...
    LIBS.translateY(PawmoRig.POSITION_MATRIX, 0.8);
