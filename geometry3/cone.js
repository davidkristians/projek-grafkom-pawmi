...
        }
        ...
        // ▼▼▼ BARU: Normal untuk alas bawah (-1, 0, 0) ▼▼▼
...
        for(let s=0; s<segments; s++){ idx.push(baseCenterIdx, baseCenterIdx+s+2, baseCenterIdx+s+1); }
        
        if (radiusTop > 0) {
            // ▼▼▼ BARU: Normal untuk tutup atas (1, 0, 0) ▼▼▼
...
            for(let s=0; s<segments; s++){ idx.push(topCenterIdx, topCenterIdx+s+1, topCenterIdx+s+2); }
        }
